    ...
    % features is considered as error measure. The function computes it for each
    % matched feature and the largest one is returned by the function.
    %
    ...
    %
    % @return sc_error Largest separation on features position
